...
func requireCoinankIntegration(t *testing.T) {
	t.Helper()
	if os.Getenv("COINANK_ENABLE_TESTS") != "1" || os.Getenv("COINANK_API_KEY") == "" {
		t.Skip("set COINANK_ENABLE_TESTS=1 and COINANK_API_KEY to run this integration test")
	}
}
