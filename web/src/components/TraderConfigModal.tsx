                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-[#848E9C]">
                    <div>
                      币种来源: {selectedStrategy.config.coin_source.source_type === 'static' ? '固定币种' :
                        (selectedStrategy.config.coin_source.source_type === 'ai500' || selectedStrategy.config.coin_source.source_type === 'coinpool') ? 'AI500' :
                        selectedStrategy.config.coin_source.source_type === 'oi_top' ? 'OI Top' :
                        selectedStrategy.config.coin_source.source_type === 'otc_top' ? 'OTC Top' : '混合'}
                    </div>
                    <div>
