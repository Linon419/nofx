...
export const translations = {
  en: {
    ...
    modelDisplayNamePlaceholder: 'e.g.: Claude Main, Claude Backup',
    telegramNotifications: 'Telegram Notifications',
    telegramEnabled: 'Enabled',
    telegramBotToken: 'Bot Token',
    telegramBotTokenPlaceholder: 'e.g.: 123456:ABC-DEF...',
    telegramBotTokenAlreadySet: 'Bot token already set (leave blank to keep)',
    telegramChatId: 'Chat ID',
    telegramChatIdPlaceholder: 'e.g.: -1001234567890',
    telegramNotifyOnOpen: 'Notify on open',
    telegramNotifyOnClose: 'Notify on close (include PnL)',
    telegramNotifyOnError: 'Notify on error',
    confirmDeleteModel:
    ...
    fetchingModelList: 'Fetching...',
    fetchModelListSuccess: 'Fetched model list',
    fetchModelListFailed: 'Failed to fetch model list',
    selectFetchedModel: 'Select from fetched models',
    testModelConfig: 'Test',
    testingModelConfig: 'Testing...',
    testModelConfigSuccess: 'Model test succeeded',
    testModelConfigFailed: 'Model test failed',
  ...
  zh: {
    ...
    modelDisplayNamePlaceholder: '例如：Claude 主力、Claude 备用',
    telegramNotifications: 'Telegram 通知',
    telegramEnabled: '启用',
    telegramBotToken: 'Bot Token',
    telegramBotTokenPlaceholder: '例如：123456:ABC-DEF...',
    telegramBotTokenAlreadySet: '已配置 Bot Token（留空则保持不变）',
    telegramChatId: 'Chat ID',
    telegramChatIdPlaceholder: '例如：-1001234567890',
    telegramNotifyOnOpen: '开仓通知',
    telegramNotifyOnClose: '平仓通知（含盈亏）',
    telegramNotifyOnError: '错误通知',
