...
func (t *HyperliquidTrader) SyncOrdersFromHyperliquid(traderID string, exchangeID string, exchangeType string, st *store.Store) error {
	...
	for _, trade := range trades {
		...
		sendTelegramTradeNotification(st, traderID, exchangeID, exchangeType, orderAction, symbol, trade.Side, trade.Quantity, trade.Price, trade.Fee, trade.RealizedPnL, trade.Time)
